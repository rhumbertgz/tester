defmodule RiakTS.Notifications do

  #TODO OJO check this carefully
  ...
  def start_link(opts) do
    Connection.start_link(__MODULE__, RiakTS.Utils.default_opts(opts))
  end
