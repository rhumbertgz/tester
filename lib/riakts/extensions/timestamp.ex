defmodule RiakTS.Extensions.Timestamp do
  @moduledoc false
  import RiakTS.BinaryUtils
  use RiakTS.BinaryExtension,
    [send: "timestamp_send", send: "timestamptz_send"]

  @gs_epoch :calendar.datetime_to_gregorian_seconds({{2000, 1, 1}, {0, 0, 0}})
  @timestamp_max_year 294276

  def encode(_, %RiakTS.Timestamp{year: year, month: month, day: day, hour: hour, min: min, sec: sec, usec: usec}, _, _)
  ...
  def encode(type_info, value, _, _) do
    raise ArgumentError,
      RiakTS.Utils.encode_msg(type_info, value, RiakTS.Timestamp)
  end
  ...
  def decode(_, <<microsecs :: int64>>, _, _) do
    ...
    %RiakTS.Timestamp{year: year, month: month, day: day, hour: hour, min: min, sec: sec, usec: usec}
  end
end
